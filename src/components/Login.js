...
const Login = () => {
  ...
  // This state is being maintined in "NotesTakingContext.js"
   // "apiCallError" contains any errors occured during api calls or in try-catch
   

  const {setAccessToken, setUserProfile, apiCallError, setApiCallError, setLogoutMessage} = useContext(NotesTakingContext);
        ...
        <p className='app-suggestion-p'>Scroll down for demo credentials ↓↓</p>
          ...
          <br />
            <div className='login-suggestion-div'>
              ...
              <Button className='home-page-Button-class' size='sm' color='warning' onClick={()=>setLoginFormData(demoCredNormalUser)}>Normal user</Button>
