...
const UserDashboard = () => {
    ...
    const {accessToken, userProfile, apiCallError, setApiCallError, logoutUserFun, config, setUserProfile} = useContext(NotesTakingContext);
        ...
        <div className='dashboard-button-div'>
            ...
            <Table responsive striped>
                <tbody>
                    ...
                    <tr>
                    <td><Button className='dashboard-Button-class' color='info' onClick={()=>navigate(`/${userProfile._id}/viewNotes`)}>View Notes</Button></td>

                    <td><Button className='dashboard-Button-class' color='warning' onClick={()=>navigate(`/${userProfile._id}/addOrEditNote`)}>Add Note</Button></td>
                    </tr>
            ...
            {viewProfile ? (
                // If the user clicked the "View your profile" button
